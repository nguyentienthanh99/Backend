...
//Lấy bánh cùng NCC
app.get('/listBanhCungNCC',function(req,res){
    var MaNCC = req.query.MaNCC;
    database.getBanhCungNCC(MaNCC,function(resultQuery){
        res.json(resultQuery);
    })
});
...
//xóa hóa đơn xuất
app.put('/xoaHDX',function(req,res){
    var MaHD = req.query.MaHD;
    database.xoaHDX(MaHD,function(resultQuery){
        res.json(resultQuery);
    });
});
